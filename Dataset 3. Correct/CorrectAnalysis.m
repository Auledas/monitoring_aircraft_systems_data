...
% Plot depth values
depth_plot = cat(1,r(1,:),r(2,:),r(3,:),r(4,:),r(5,:),r(6,:),r(7,:),r(8,:),r(9,:),r(10,:),r(11,:),r(12,:),r(13,:),r(14,:),r(15,:),r(16,:),r(17,:),r(18,:),r(19,:),r(20,:));
...
% Uncomment the function below to plot height values
%{
height_plot = cat(1,h(1,:),h(2,:),h(3,:),h(4,:),h(5,:),h(6,:),h(7,:),h(8,:),h(9,:),h(10,:),h(11,:),h(12,:),h(13,:),h(14,:),h(15,:),h(16,:),h(17,:),h(18,:),h(19,:),h(20,:));
